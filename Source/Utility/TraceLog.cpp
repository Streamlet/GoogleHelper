...
#define LOG_PREFIX  _T("[GoogleHelper]")
...
#define CONFIG_VALUE_LOG_CONTENT_TIME      0x00000002
#define CONFIG_VALUE_LOG_CONTENT_LEVEL     0x00000004
#define CONFIG_VALUE_LOG_CONTENT_MESSAGE   0x00000008
#define CONFIG_VALUE_LOG_CONTENT_FILE      0x00000010
#define CONFIG_VALUE_LOG_CONTENT_FUNCTION  0x00000020
#define CONFIG_VALUE_LOG_CONTENT_LINE      0x00000040
...
#define CONFIG_VALUE_DEFAULT_LOG_CONTENT   (CONFIG_VALUE_LOG_CONTENT_PREGIX  | CONFIG_VALUE_LOG_CONTENT_TIME  | CONFIG_VALUE_LOG_CONTENT_LEVEL | CONFIG_VALUE_LOG_CONTENT_MESSAGE | CONFIG_VALUE_LOG_CONTENT_LINE)
#define CONFIG_VALUE_DEFAULT_LOG_FILE      _T("%Temp%\\GoogleHelper.log")
#else
...
LogPolicy &LogPolicy::GetInstance()
{
    ...
    if (!initialized_)
    {
        ...
        ExpandEnvironmentStrings(CONFIG_VALUE_DEFAULT_LOG_FILE, szPath, MAX_PATH);
        instance.logFile_    = szPath;
...
#ifdef COMPLIE_TIME_LOG_CONTENT_TIME
    if ((logContent_ & CONFIG_VALUE_LOG_CONTENT_TIME) != 0)
    {
        SYSTEMTIME st = {};
        GetSystemTime(&st);
